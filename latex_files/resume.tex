...
\resumeSubHeadingListStart
  ...
  \resumeSubheading
    ...
    \resumeItemListStart
      \resumeItem{Led data-driven product analytics and developed a Random Forest churn prediction model that achieved 90\% precision in the top decile, preventing over \$240M in potential revenue loss. Translated quantitative insights into business recommendations that increased customer retention by 6\%.}
      \resumeItem{Introduced an OCR-based computer vision system processing 60K+ bills of lading daily. Extracted structured data into BigQuery and SQL-based pipelines, supporting large-scale data measurement, metrics tracking, and evaluation frameworks.}
      \resumeItem{Designed an end-to-end LLM pipeline using Google Gemini, GCP, and Vertex AI integrating CV, NLP, and OCR workflows for automated invoice extraction and classification, enabling scalable, production-ready data science applications.}
      \resumeItem{Served as analytics partner to engineering and product teams, communicating complex model outputs through visualization, statistical storytelling, and clear summaries to support data-informed product decisions.}
    \resumeItemListEnd
  ...
  \resumeSubheading
    ...
    {XPO Logistics}{Pune, India}
    \resumeItemListStart
      \resumeItem{Partnered with McKinsey to develop an ML-based logistics simulation model (Cerebro) implemented across 300+ centers, applying program evaluation, statistical experimentation, and quantitative analysis to improve freight handling efficiency by 54\%.}
      \resumeItem{Developed a computer vision audit platform using GCP, Pub/Sub, SQL, and Vertex AI Pipelines, processing 80K+ documents daily, enhancing data quality metrics and saving 10K+ manual hours annually.}
      \resumeItem{Created CNN-based models for accessorial optimization and trailer image analysis. Analyzed statistical trends and performance metrics to improve product reliability and generate \$1.3M in incremental revenue.}
    \resumeItemListEnd
  ...
  \resumeSubheading
    ...
    \resumeItemListStart
      \resumeItem{Built decision tree models to detect fraudulent claims using Vertex AI and SQL queries on structured datasets, generating \$15K monthly. Enhanced scalability, reproducibility, and statistical model evaluation.}
