...
\resumeSubHeadingListStart
  ...
  \resumeSubheading
    ...
    \resumeItemListStart
      \resumeItem{Utilized machine learning concepts to develop predictive models with high precision, achieving 90\% accuracy in identifying top decile churners and preventing over \$240M in potential revenue loss.}
      \resumeItem{Developed and implemented an OCR-based computer vision system processing 60K+ bills of lading daily, extracting structured data into BigQuery and SQL-based pipelines for large-scale measurement, metrics tracking, and evaluation.}
      \resumeItem{Designed and integrated a comprehensive LLM pipeline using Google Gemini, GCP, and Vertex AI, combining CV, NLP, and OCR workflows for automated invoice extraction and classification in production-ready applications.}
      \resumeItem{Collaborated with engineering and product teams to effectively communicate complex model outputs through visualization, statistical storytelling, and clear summaries, supporting data-informed product decisions.}
    \resumeItemListEnd
  ...
  \resumeSubheading
    ...
    {XPO Logistics}{Pune, India}
    \resumeItemListStart
      \resumeItem{Partnered with McKinsey to develop a large-scale ML-based logistics simulation model (Cerebro) applied across 300+ centers, demonstrating significant improvements in freight handling efficiency by 54\%.}
      \resumeItem{Created and deployed computer vision audit platforms using GCP, Pub/Sub, SQL, and Vertex AI Pipelines, processing 80K+ documents daily with notable enhancements to data quality metrics and annual savings of 10K+ manual hours.}
      \resumeItem{Designed CNN-based models for accessorial optimization and trailer image analysis, analyzing statistical trends and performance metrics to drive significant improvements in product reliability and generate \$1.3M in incremental revenue.}
    \resumeItemListEnd
  ...
  \resumeSubheading
    ...
    \resumeItemListStart
      \resumeItem{Built decision tree models using Vertex AI and SQL queries on structured datasets, achieving accuracy rates that generated over \$15K monthly with enhanced scalability and reproducibility.}
      \resumeItem{Developed ARIMA-based time series forecasting models in R, Python, and BQML to predict employee attrition, effectively communicating insights through data visualization, storytelling, and stakeholder reports for data-driven workforce planning.}
    \resumeItemListEnd
...
\resumeSubHeadingListStart
  ...
  \resumeProjectHeading
    {\textbf{Transformer based Hindi poetry generator} $|$ \emph{TensorFlow, NLTK, Transformers, Keras, SQL, R}}{}
    \resumeItemListStart
      \resumeItem{Built custom Transformer-based generative models leveraging natural language processing (NLP) and statistical text analysis, applying data wrangling, feature engineering, and model evaluation metrics to assess creativity and linguistic coherence.}
    \resumeItemListEnd

  \resumeProjectHeading
    {\textbf{Implementation of Sparsity Invariant CNNs} $|$ \emph{OpenCV, Scikit-learn, PyTorch, Pandas}}{}
    \resumeItemListStart
