...
\resumeSubHeadingListStart
  ...
  \resumeSubheading
    ...
    \resumeItemListStart
      \resumeItem{Analyzed real-time machine learning systems operating on streaming RF data, developing novel algorithms for GPU-accelerated digital signal analysis across diverse domains.}
      \resumeItem{Executed Python-based digital signal processing tasks including filtering, spectral analysis, and waveform generation, integrating solutions to run in real systems to demonstrate effectiveness.}
      \resumeItem{Worked alongside a team of developers to engage in data processing pipelines, training ML systems, analyzing outcomes, and tackling real-world issues related to RF Machine Learning.}
      \resumeItem{Communicated complex model outputs through visualization, statistical storytelling, and clear summaries to support data-informed product decisions in the field of digital signal processing and machine learning.}
    \resumeItemListEnd
  ...
  \resumeSubheading
    ...
    {XPO Logistics}{Pune, India}
    \resumeItemListStart
      \resumeItem{Developed expertise in modern programming languages (Python preferred), familiarity with command line and version control (Git) experience, and proficiency in signal processing concepts.}
      \resumeItem{Utilized modern DevOps and MLOps tools to deploy and integrate solutions, ensuring seamless execution of digital signal processing tasks and ML systems.}
      \resumeItem{Collaborated on data analysis projects related to RF Machine Learning, utilizing expertise in statistical analysis, visualization, and communication to drive insights and recommendations.}
    \resumeItemListEnd
  ...
  \resumeSubheading
    ...
    \resumeItemListStart
      \resumeItem{Worked on real-world issues related to RF Machine Learning, leveraging knowledge of machine learning algorithms, data structures, and software development principles to develop innovative solutions.}
